const contentData = {
    ...
    // Video
    videoSide: {
    video: 'http://cos-public.seewo.com/public_appId-dev/uwiykzyzhihunhozhqliukmhijhhihhh.mp4',
    title: 'Climbing towards NLU: On Meaning, Form, and Understanding in the Age of Data',
    content: 'Emily M. Bender, University of Washington; Alexander Koller, Saarland University'
    },
    newsSide: {
    title: 'Additional Resources and Insights',
    content: "Here's extra web info and reference materials to help you dig deeper.",
    newsLinks: [
    {
    title: 'AI and the Language Barrier',
    links: 'https://bulletin.hku.hk/cover-story-theme/ai-and-the-language-barrier/'
    },
    {
    title: 'Does artificial intelligence really understand us?',
    links: 'https://www.sri.com/press/story/does-artificial-intelligence-really-understand-us/'
    },
    {
    title: 'Does AI Actually Understand Language?',
    links: 'https://www.theatlantic.com/technology/archive/2024/09/does-ai-understand-language/680056/'
    }
    ]
    }
    },
    ...
    // Video
    videoSide: {
    video: 'http://cos-public.seewo.com/public_appId-dev/uwiykzyzhihunhozhqliukvixphhihhh.mp4',
    title: 'How ChatGPT Works Technically',
    content: 'Produced by ByteByteGo.com, this video delves deep into how ChatGPT operates technically, guiding you through the principles and mysteries behind it.'
    },
    newsSide: {
    title: 'Additional Resources and Insights',
    content: "Here's extra web info and reference materials to help you dig deeper.",
    ...
    links: 'https://www.pnas.org/doi/10.1073/pnas.2215907120'
    },
    {
    title: 'GPT-4 from OpenAI.com',
    links: 'https://openai.com/research/gpt-4'
    },
    {
    title: 'Generative pre-trained transformer',
    links: 'https://en.wikipedia.org/wiki/Generative_pre-trained_transformer'
    }
    ]
    }
    },
    ...
    // Video
    videoSide: {
    video: 'http://cos-public.seewo.com/public_appId-dev/uwiykzyzhihunhozhqliukzkqihhihhh.mp4',
    title: 'Can You Spot the Fake? AI Video vs. Real Life Challenge!',
    content: "Join David in a fun challenge on Payette Forward's channel to tell AI - generated from real - life videos, and learn to spot AI - made ones."
    },
    newsSide: {
    title: 'Additional Resources and Insights',
    content: "Here's extra web info and reference materials to help you dig deeper.",
    ...
    links: 'https://www.nature.com/articles/s41598-025-94170-3'
    },
    {
    title: 'What are Deepfakes?',
    links: 'https://cyble.com/knowledge-hub/what-are-deepfakes/'
    },
    {
    title: 'AIGC Media Market Size...',
    links: 'https://www.businessresearchinsights.com/market-reports/aigc-media-market-112954'
    }
    ]
    }
    },
    ...
    // Video
    videoSide: {
    video: 'http://cos-public.seewo.com/public_appId-dev/uwiykzyzhihunhozhqliujpuinhhihhh.mp4',
    title: 'Understanding Intellectual Property (IP)',
    content: 'Learn about Intellectual Property (IP), patents, copyrights, and technology transfer in this FederalLabs video.'
    },
    newsSide: {
    title: 'Additional Resources and Insights',
    content: "Here's extra web info and reference materials to help you dig deeper.",
    ...
    links: 'https://en.wikipedia.org/wiki/Artificial_intelligence_art'
    },
    {
    title: 'Who owns AI art? AI-generated Ghibli selfies spark legal debate',
    links: 'https://www.koreaherald.com/article/10472005'
    },
    {
    title: 'Who owns AI-generated artwork? Revisiting the work of generative AI based on human-AI co-creation',
    links: 'https://www.sciencedirect.com/science/article/abs/pii/S0736585325000280'
    }
    ]
    }
    },
    ...
    // Video
    videoSide: {
    video: 'http://cos-public.seewo.com/public_appId-dev/uwiykzyzhihunhozhqliuljzqwhhihhh.mp4',
    title: 'AI-powered mental health chatbots developed as a therapy support tool',
    content: 'Explore how AI - powered mental health chatbots aid those with depression, anxiety, etc., and the concerns some therapists have. '
    },
    newsSide: {
    title: 'Additional Resources and Insights',
    content: "Here's extra web info and reference materials to help you dig deeper.",
    newsLinks: [
    {
    title: 'Delivering Cognitive Behavior Therapy to Young Adults...',
    links: 'https://mental.jmir.org/2017/2/e19'
    },
    {
    title: 'AI Companions: Weird and Creepy or Worth Your Attention?',
    links: 'https://genies.com/blog/ai-companions-weird-and-creepy-or-worth-your-attention'
    },
    {
    title: 'The impacts of companion AI on human relationships...',
    links: 'https://link.springer.com/article/10.1007/s00146-025-02318-6'
    }
    ]
    }
    },
    ...
    // Video
    videoSide: {
    video: 'http://cos-public.seewo.com/public_appId-dev/uwiykzyzhihunhozhqliulnyjkphihhh.mp4',
    title: 'Artificial Intelligence Meets Mental Health Therapy',
    content: 'Andy Blackwell shares how his team uses AI in mental health care, results from treating thousands of patients, and his vision for mental health treatment.'
    },
    newsSide: {
    title: 'Additional Resources and Insights',
    content: "Here's extra web info and reference materials to help you dig deeper.",
    newsLinks: [
    {
    title: 'Why AI therapists could further isolate vulnerable patients instead of easing suffering',
    links: 'https://theconversation.com/why-ai-therapists-could-further-isolate-vulnerable-patients-instead-of-easing-suffering-246206'
    },
    {
    title: "AI Therapists Are Biased—And It's Putting Lives at Risk",
    links: 'https://www.psychologytoday.com/us/blog/the-human-algorithm/202504/ai-therapists-are-biased-and-its-putting-lives-at-risk'
    },
    {
    title: 'Some Things Should Stay Human: The Quiet Risks of AI Therapists',
    links: 'https://medium.com/@aashishdhawan_2946/some-things-should-stay-human-the-quiet-risks-of-ai-therapists-582137347604'
    }
    ]
    }
    },
